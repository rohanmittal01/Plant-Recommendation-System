...
export class ProductService {
  ...
  getFamilyData(family){
    return this.http.get(this.baseUrl + 'products/family/' + localStorage.getItem('family'));
  }

  getFamilyAvailableData(family){
    return this.http.get(this.baseUrl + 'products/family/available/' + localStorage.getItem('family'));
  }
